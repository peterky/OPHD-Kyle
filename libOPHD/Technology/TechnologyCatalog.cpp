...
namespace
{
	std::map<std::string, Technology::Modifier::Modifies> StringToModifier =
	{
		...
		{"explorer", Technology::Modifier::Modifies::ExplorerEfficiency},
		{"maintenance_cost", Technology::Modifier::Modifies::MaintenanceCost},
		{"mining", Technology::Modifier::Modifies::MiningEfficiency},
		{"ore_haul", Technology::Modifier::Modifies::OreHaulEfficiency},
